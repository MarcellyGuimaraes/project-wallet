<div class="max-w-sm mx-auto bg-white p-8 rounded-xl border border-neutral-200 shadow-sm">
    <h1 class="text-lg font-semibold mb-1 text-neutral-900 tracking-tight">Transferir</h1>
    ...
    <form wire:submit="transfer" class="space-y-4">
        <div>
            <label class="block text-sm font-medium mb-1.5 text-neutral-700" for="recipient_email">E-mail do destinatário</label>
            <input wire:model="recipient_email" id="recipient_email" type="email" class="w-full rounded-md border-neutral-300 text-sm shadow-sm transition-shadow focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900">
            @error('recipient_email') <p class="text-sm text-red-700 mt-1.5">{{ $message }}</p> @enderror
        </div>
