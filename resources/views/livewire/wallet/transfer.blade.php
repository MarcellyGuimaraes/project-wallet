<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-sm">
    <h1 class="text-xl font-semibold mb-1">Transferir</h1>
    ...
    <form wire:submit="transfer" class="space-y-4">
        <div>
            <label class="block text-sm font-medium mb-1" for="recipient_email">E-mail do destinatário</label>
            <input wire:model="recipient_email" id="recipient_email" type="email" class="w-full rounded border-gray-300 shadow-sm">
            @error('recipient_email') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
        </div>
